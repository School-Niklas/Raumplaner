...
/*
    public Stuhl duplizieren() throws CloneNotSupportedException {
        Stuhl cloneobj = (Stuhl) super.clone();
        cloneobj.bewegeVertikal(this.xPosition);
        cloneobj.bewegeHorizontal(this.yPosition);
        if(this.istSichtbar)
            cloneobj.zeige();
        cloneobj.dreheAuf(this.orientierung);
        cloneobj.aendereFarbe(this.farbe);
        return cloneobj;
    }
*/
    /**
